              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.pushNamed(
                            context, '/courses/train/${course.id}');
                      },
                      child: const Padding(
                        ...
                        child: Align(
                            ...
                            child:
                                Text('Train', style: AppTextStyles.mediumBold)),
                      ))
                ],
              ),
            ),
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                course.id == courseProvider.selectedCourse?.id
                    ? const Text(
                        'Selected',
                        style: AppTextStyles.simpleBold,
                      )
                    : IconButton(
                        onPressed: () {
                          Course? courseToSet =
                              courseProvider.getSpecificCourse(course.id);
